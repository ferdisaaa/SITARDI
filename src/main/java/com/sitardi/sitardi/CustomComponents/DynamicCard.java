...
import com.sitardi.sitardi.Form.TambahEditPemilih;
import java.net.URL;
...
public class DynamicCard {
    ...
    private static JPanel createUserButtons(User u, UserService service) {
        ...
        btnEdit.addActionListener(e -> {
            ...
            JOptionPane.showMessageDialog(null, "Fitur Edit User untuk " + u.getName());
        });
    ...
    private static String formatLabelName(String name) {
        // Mengubah "url_img" atau "nikNumber" menjadi "Url Img" atau "Nik Number"
